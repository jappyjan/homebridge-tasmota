...
import {tasmotaIrTvRemoteService} from './tasmotaIrTvRemoteService';
...
type AnyService = tasmotaSwitchService | tasmotaLightService | tasmotaSensorService | tasmotaBinarySensorService | tasmotaFanService | tasmotaIrTvRemoteService;
...
export class tasmotaPlatform implements DynamicPlatformPlugin {
    ...
    public readonly services: AnyService[] = [];
...
function setConfiguredName(this: AnyService, value, callback: CharacteristicSetCallback) {
